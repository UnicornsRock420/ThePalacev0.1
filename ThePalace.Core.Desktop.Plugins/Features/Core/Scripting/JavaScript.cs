...
using ThePalace.Core.Desktop.Plugins.Options.Core.Scripting.JavaScript;
using ThePalace.Core.Enums;

namespace ThePalace.Core.Desktop.Plugins.Features.Core.Scripting
{
    public sealed class JavaScript : IProvider
    {
