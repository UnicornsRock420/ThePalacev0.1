...
namespace ThePalace.Core.Constants
{
    public static class AssetConstants
    {
        ...
        public const int MaxNbrProps = 9;
        public const int DefaultPropWidth = 44;
        public const int DefaultPropHeight = 44;
        public const int DefaultAvatarWidth = 132;
        public const int DefaultAvatarHeight = 132;
        ...
        public static readonly uint[] PalacePalette = new uint[] {
